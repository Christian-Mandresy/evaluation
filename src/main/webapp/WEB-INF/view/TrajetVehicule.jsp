...
<%@ page import="com.vehicule.app.model.Trajet" %>
<!DOCTYPE html>
<html lang="en">
  <head>
    <!-- Required meta tags -->
                  ...
                  <div class="card-body">
                    ...
                    <table class="table table-dark">
                      <thead>
                        <tr>
                          <th> Motif </th>
                          <th> Quantite Carburant </th>
                          <th> Prix </th>
                          <th> chauffeur </th>
                        </tr>
                      </thead>
                      <tbody>
                      <c:forEach items="${requestScope.ListTrajet}" var="lists">
                        <tr>
                          <td>${lists.getMotif()}</td>
                          <td>${lists.getQuantite_carburant()}</td>
                          <td>${lists.getPrix_carburant()}</td>
                          <td>${lists.getId_utilisateur()}</td>
                        </tr>
                      </c:forEach>
                      </tbody>
                    </table>

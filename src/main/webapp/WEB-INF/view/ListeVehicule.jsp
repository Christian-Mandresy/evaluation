                  ...
                  <div class="card-body">
                    ...
                    <table class="table table-dark">
                      ...
                      <c:forEach items="${requestScope.ListVehicule}" var="lists">
                        <tr>
                          <td>${lists.getNumero()}</td>
                          <td>${lists.getMarque()}</td>
                          <td>${lists.getModel()}</td>
                          <td>${lists.getTypeVehicule().getNom()}</td>
                          <td><a href="listeTrajet?id=${lists.getTypeVehicule().getId()}">Details</a></td>
                        </tr>
                      </c:forEach>
                      </tbody>
                    </table>
